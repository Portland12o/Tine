...
<template>
  <header class="navbar" :class="{ scrolled }">
    <div class="container navbar-inner">
      <a class="navbar-logo" @click.prevent="navigate('/')">
      ...
      <nav class="navbar-links">
        <a
          ...
          :key="link.to"
          class="nav-link"
          :class="{ active: route.path === link.to || (link.to === '/' && route.path === '/') }"
          @click.prevent="navigate(link.to)"
        >
          {{ link.name }}
          <span v-if="route.path === link.to || (link.to === '/' && route.path === '/')" class="nav-indicator" />
        </a>
